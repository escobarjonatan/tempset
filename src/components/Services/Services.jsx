...
const Services = () => (
  <section id="services" className="p-8 mt-11 bg-white rounded-lg shadow">
    ...
    At Tempset HVAC Services, we make every effort to achieve your satisfaction.
    </p>
    <div
    ...
    >
      ...
      <Service name="Maintenance" icon={maintenance} description="We can schedule reocurring service appointments to keep your unit running and maximize the lifespan."/>
