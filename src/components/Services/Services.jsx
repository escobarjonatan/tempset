...
const Services = () => (
  <section id="services" className="p-8 mt-11 bg-white rounded-lg shadow">
    ...
    <p className="text-center mb-11 sm:text-xl">
      At Tempset HVAC Services, we make every effort to achieve your
      satisfaction.
    </p>
    <div
    ...
    >
      <Service
        name="FREE Estimates"
        icon={fan}
        description="Estimates are free, including commercial work. Give our team a call to schedule an appointment and help answer any questions you may have."
      />
      <Service
        name="Troubleshooting"
        icon={troubleshoot}
        description="Not sure what is wrong with your HVAC system? Let us help you figure out what the next steps are in order to get your unit operating safely."
      />
      <Service
        name="Installations"
        icon={installation}
      ...
      <Service
        name="Repairs"
        icon={worker}
        description="We believe that no job is too small or too big. Our technicians will ensure that all of your concerns are taken care of."
      />
    </div>
  </section>
);
