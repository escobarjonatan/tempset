        ...
        <div className="sm:flex text-center align-center justify-center mt-11">
          <div className="sm:w-1/2 w-full self-center">
            <div className="mb-3">
              ...
              <a
                className="underline focus:ring-2 focus:ring-red-600 active:ring-red-500 focus:outline-none rounded-sm"
                href="tel:832-762-1842"
              >
                832-762-1842
              </a>
            </div>
            <div className="mb-3">
              ...
              <a
                className="underline focus:ring-2 focus:ring-red-600 active:ring-red-500 focus:outline-none rounded-sm"
                href="mailto:tempsethvac@gmail.com"
              >
